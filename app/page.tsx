  ...
  const projects = [
    {
      ...
      slug: 'masterset',
      category: 'iOS App',
      description: 'A premium TCG companion app for collectors and vendors. Scan cards with your camera, track collection value in real-time, manage wishlists, and browse sets with holographic card animations inspired by Pokemon Pocket TCG.',
      techStack: ['SwiftUI', 'Supabase', 'Vision Framework', 'CloudKit'],
      featured: true,
    },
    {
      title: 'HTX REI Group',
      ...
      description: 'A social media platform for wholesale real estate investors to network, list deals, find contractors, and access education. Features a deal marketplace, community forum, CRM tools, and Stripe-powered subscriptions.',
    ...
    },
    {
      ...
      slug: 'familyconnect',
      category: 'Mobile App',
      description: 'Secure, Signal-encrypted messaging app for military families and coparenting. Features a kids mode with drawing and stickers, video calls with AR filters, scheduled messages, and a storytelling mode for reading bedtime stories remotely.',
      techStack: ['React Native', 'Expo', 'Signal Protocol', 'WebRTC', 'Supabase'],
      featured: true,
    },
    {
      title: 'Real Estate Underwriting Extension',
      slug: 'real-estate-extension',
      category: 'Browser Extension',
      description: 'Intelligent Chrome extension that scrapes property addresses, pulls MLS and public record data, estimates ARV, and recommends creative finance strategies for real estate investors.',
