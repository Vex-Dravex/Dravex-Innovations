...
export default function Footer() {
    ...
    const footerLinks = {
        ...
        Projects: [
            ...
            { label: 'Creative Finance Platform', href: '/projects/creative-finance' },
            { label: 'Real Estate Extension', href: '/projects/real-estate-extension' },
    ...
    return (
        <footer className="bg-gradient-to-b from-transparent to-black/30 border-t border-white/10">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-400 text-sm">
                            Building custom software and hardware solutions for real-world business and consumer problems.
                        </p>
                        {/* Social Links */}
                ...
                <div className="pt-8 border-t border-white/10">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <p className="text-gray-400 text-sm">
                            © {new Date().getFullYear()} Dravex Innovations. All rights reserved.
                        </p>
